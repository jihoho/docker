...
# $FIELDNAME 값은 docker-compose.yml 파일에 설정되어있음
# https://github.com/ChulseoungChae/docker-compose/blob/master/csv2tsdb_and_preprocessing_v2/compose/docker-compose.yml
field=$FIELDNAME
# [2] time field name
#ts="RECORD_TIME"
ts=$TIMEFIELD
