...
def query_to_getids_v2(meta):
    ...
    ###################### add ######################
    return_data = (
    id_list, dps_num_dict, dps_percent_dict, period_len_num, sorted_dps_num, sorted_dps_per, non_exist_dps_num_dict,
    non_exist_dps_per_dict, grouped_dict)
    ###################### /add ######################
